public class Cryptography {
  ...
  public static void main(String[] args) { 
    new Main("Sami is a champion boy", 3);
  }
  
  
  public Main(String originalMessage, int shift) {
    
    String output = caeserShift(originalMessage, shift);
    
    System.out.prntln(output);
    System.out.println("");
    
    System.out.println(caesarShift(output, -offset));
  }
